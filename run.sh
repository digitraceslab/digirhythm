...
srun --mem=80GB python3 -m src.features.momomood.sensors.run_processor processor.sensor=call processor.frequency=4epochs
srun --mem=80GB python3 -m src.features.corona.sensors.run_processor processor.sensor=activity processor.frequency=4epochs
srun --mem=80GB python3 -m src.features.tesserae.run_processor processor.sensor=screen processor.frequency=4epochs

srun --mem=80GB python3 -m src.features.momomood.eigenbehav.run_processor 
srun --mem=80GB python3 -m src.features.corona.sensors.run_processor processor.sensor=survey processor.frequency=all
